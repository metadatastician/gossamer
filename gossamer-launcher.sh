...
# @a2ml-metadata begin
# (
#   id                   = "gossamer-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "gossamer"
#   app-display          = "Gossamer"
#   app-url              = ""
...
#
# ============================================================================
# gossamer-launcher.sh — Gossamer
# ============================================================================
# GENERATED by launch-scaffolder from gossamer.launcher.a2ml.
...
APP_DESC="A linearly-typed webview shell"
APP_CATEGORIES="Development;System;Utility;"
APP_GENERIC_NAME="Gossamer"
...
START_COMMAND=""
for candidate in \
    "/cli/launcher/gossamer-launcher" \
    "/cli/launcher/gossamer" \
    "gossamer-launcher" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in gossamer.launcher.a2ml."
            return 1
        fi
    fi
