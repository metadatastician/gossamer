...
#
# gossamer — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: gossamer-release)
...
CT_KEY_ID="${CT_KEY_ID:-gossamer-release}"
...
echo "=== gossamer Cerro Torre Build Pipeline ==="
