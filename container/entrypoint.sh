...
cleanup() {
    echo "Received shutdown signal — stopping gossamer..."
...
# Examples:
#   exec /app/gossamer
#   exec /app/release/bin/gossamer start
#   exec /app/gossamer serve --host "${APP_HOST}" --port "${APP_PORT}"
