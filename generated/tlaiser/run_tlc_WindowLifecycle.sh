...
# TLC run script for WindowLifecycle — generated by tlaiser
...
echo "Running TLC on WindowLifecycle.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config WindowLifecycle.cfg WindowLifecycle.tla
