...
# TLC run script for WindowGuard — generated by tlaiser
...
echo "Running TLC on WindowGuard.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config WindowGuard.cfg WindowGuard.tla
